...
const categories = [
  {
    ...
    tags: ['React.js', 'JavaScript', 'HTML5', 'CSS3', 'Responsive Design', 'Tailwind CSS'],
  },
  {
    icon: '⚙️',
    name: 'Backend Engineering',
    tags: ['Node.js', 'Express.js', 'REST APIs', 'Authentication', 'JWT', 'API Development'],
  },
  {
    icon: '🗄️',
    name: 'Databases',
    tags: ['MongoDB', 'Mongoose', 'SQL', 'Database Design', 'Data Modeling'],
  },
  {
    icon: '🛒',
    name: 'E-commerce & Shopify',
    tags: ['Shopify App Dev', 'Shopify APIs', 'Subscription Systems', 'Payment Integrations'],
  },
  {
    icon: '🤖',
    name: 'AI & Automation',
    tags: ['AI Integrations', 'Automation Systems', 'Chatbots', 'AI Evaluation', 'OpenAI APIs'],
  },
  {
    icon: '🚀',
    name: 'DevOps & Deployment',
    tags: ['Git', 'GitHub', 'VPS Deployment', 'PM2', 'Nginx', 'Linux'],
  },
]
...
function SkillCard({ cat, index }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ fontWeight: 700, color: 'var(--white)', marginBottom: '1rem', fontFamily: 'var(--font-display)', fontSize: '0.95rem' }}>
        {cat.name}
      </div>
    ...
    <section id="skills" style={{ padding: '6rem 0' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 2rem' }}>
        ...
        <div style={{
          ...
          {categories.map((cat, i) => <SkillCard key={cat.name} cat={cat} index={i} />)}
        </div>
      </div>
