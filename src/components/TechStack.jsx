          ...
          >
            ...
            >
              ...
              <div style={{
                ...
                background: 'rgba(8,8,15,0.96)', border: '1px solid rgba(255,255,255,0.08)',
                padding: '0.25rem 0.6rem', borderRadius: 6, fontSize: '0.7rem', color: 'var(--white)',
                whiteSpace: 'nowrap', pointerEvents: 'none', opacity: 0,
                transition: 'opacity 0.2s',
              }} className="orbit-tooltip">{tech.name}</div>
            </motion.div>
          </div>
        )
      })}
  ...
  return (
    <section id="techstack" style={{ padding: '6rem 0', overflow: 'hidden' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 2rem' }}>
        ...
        >
          ...
          <p style={{ color: 'var(--muted)', maxWidth: 480, margin: '0 auto', lineHeight: 1.7 }}>
            The core technologies I use to build scalable, production-grade products.
          </p>
        </motion.div>
      ...
      <style>{`
        ...
        .orbit-wrap div:hover .orbit-tooltip { opacity: 1 !important; }
