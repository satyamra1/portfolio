    ...
    <section id="stats" style={{ background: 'var(--bg-2)', padding: '6rem 0' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 2rem' }}>
        ...
        >
          ...
          <h2 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(2rem,3.5vw,2.8rem)', fontWeight: 800, lineHeight: 1.1, marginBottom: '0.75rem' }}>Highlights & Achievements</h2>
          <p style={{ color: 'var(--muted)', maxWidth: 480, margin: '0 auto', lineHeight: 1.7 }}>Numbers that reflect real work, real products, and real impact delivered across multiple domains.</p>
        </motion.div>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '1.5rem', marginBottom: '3rem' }} className="stats-grid">
          {items.map((item, i) => (
            <motion.div
              key={item.label}
            ...
            >
              ...
              <div style={{ fontSize: '3rem', fontWeight: 800, fontFamily: 'var(--font-display)', lineHeight: 1, background: 'linear-gradient(135deg,var(--cyan),var(--purple))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', marginBottom: '0.5rem' }}>
        ...
        >
          {highlights.map(h => (
            <motion.div key={h.label} whileHover={{ scale: 1.05 }} style={{
              ...
              onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(0,217,255,0.2)'; e.currentTarget.style.color = 'var(--white)'; e.currentTarget.style.background = 'rgba(0,217,255,0.05)' }}
              onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(255,255,255,0.07)'; e.currentTarget.style.color = 'var(--muted)'; e.currentTarget.style.background = 'rgba(255,255,255,0.03)' }}
            >
