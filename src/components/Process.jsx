      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 2rem' }}>
            ...
            <div key={step.name} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              >
                <motion.div
                  ...
                  style={{
                    ...
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    fontSize: '1.6rem', marginBottom: '0.6rem',
                ...
                >
                  ...
                  <div style={{
                    ...
                    borderRadius: '50%', background: 'linear-gradient(135deg, var(--cyan), var(--purple))',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    fontSize: '0.6rem', fontWeight: 700, color: '#050505',
                  }}>{i + 1}</div>
                </motion.div>
              ...
              {i < steps.length - 1 && (
                <motion.div
                  ...
                  style={{ color: 'var(--muted)', fontSize: '1.1rem', marginBottom: '1.2rem', flexShrink: 0 }}
        ...
        >
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            <h3 style={{ fontFamily: 'var(--font-display)', fontWeight: 700, color: 'var(--white)', marginBottom: '0.75rem', fontSize: '1.1rem' }}>
              Product-First, Technology-Enabled
            </h3>
